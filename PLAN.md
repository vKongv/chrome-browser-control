...
- Shared pairing token supplied through `CHROME_BROWSER_CONTROL_TOKEN` and the extension popup.
...
- Optional broker-side extension ID pinning through `CHROME_BROWSER_CONTROL_EXTENSION_ID`.
